<?php require "../acoes/verifica.php"; ?>
  ...
  <head>
    ...
    <title>Excluir Patrimonio</title>
  ...
  <body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page-content inset">
        <div class="row">
          <div class="col-md-12">
            <p class="well lead">Excluir Patrimonio</p>
                ...
                <div class="col-sm-8 contact-form"> 
                  ...
                  <div class="row">
                    ...
                    if (pg_affected_rows($result)!=0){
                      ...
                      echo "<h2>Patrimonio excluído com sucesso</h2>";
                    }else{

                      echo "<h2> Patrimonio NÃO excluída</h2><br><br>";
