  ...
  <body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="page-content inset">
        <div class="row">
          <div class="col-md-12">
            <p class="well lead">Excluir MBP</p>
              ...
              <div class="row">
                ...
                <div class="col-sm-8 contact-form"> 
                  ...
                  <div class="row">
                    ...
                    $sql = "DELETE FROM mbp WHere numero=".$iptexcluir;
                    ...
                    if (pg_affected_rows($result)!=0){
                      ...
                      echo "<h2>MBP excluída com sucesso</h2>";
                    }else{

                      echo "<h2> MBP NÃO excluída</h2><br><br>";
